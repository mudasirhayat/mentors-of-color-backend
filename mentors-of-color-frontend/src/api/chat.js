...
// utils
import { fetcher, fetcher1, fetcherPost } from 'utils/axios';
...
export function useGetUsersBE(programUserID) {
  const { data, isLoading, error, isValidating } = useSWR(`chat/${programUserID}/rooms/`, fetcher1, {
    revalidateIfStale: false,
    revalidateOnFocus: false,
    revalidateOnReconnect: false
  });
