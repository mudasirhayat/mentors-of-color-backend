...
export const MenuFromAPI = () => {
  let { menu, menuLoading } = useGetMenu();

  if (menuLoading) return loadingMenu;

  //filtering out only dashboard component
  const filteredChild = menu.children.find(child => child.id === "dashboard");
  menu = { ...menu, children: [filteredChild] };
