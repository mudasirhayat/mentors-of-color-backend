...
const allUserTypes = ["Moderator"];

// ==============================|| CUSTOMER ADD ||============================== //

const InviteModeratorForm = ({ closeModal, program }) => {
  const theme = useTheme();
  const {
    user: { id: loginUserID, account_id: accountID },
  } = useAuth();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        newCustomer.program_id = program?.id;

        await inviteUser(newCustomer, loginUserID, accountID);
        openSnackbar({
          open: true,
        ...
        openSnackbar({
          open: true,
          message: "Some error occurred while sending invitation email.",
          variant: "alert",
          alert: {
            color: "error",
          },
      ...
      <FormikProvider value={formik}>
        <LocalizationProvider dateAdapter={AdapterDateFns}>
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            <DialogTitle>
              Invite Moderator for {program?.name} program
            </DialogTitle>
            <Divider />
...
InviteModeratorForm.propTypes = {
  closeModal: PropTypes.func,
};

export default InviteModeratorForm;
