...
const InviteMemberForm = ({ closeModal, programId }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        newCustomer.program_id = programId;
        if (newCustomer?.type === "Mentor") newCustomer.is_mentor = true;
        if (newCustomer?.type === "Mentee") newCustomer.is_mentee = true;
                    ...
                    <Grid item xs={12}>
                      <Stack spacing={1}>
                        ...
                        <TextField
                          fullWidth
                          id="customer-email"
                          placeholder="Enter mentor/mentee email"
                          {...getFieldProps("email")}
                        ...
                        <FormControl fullWidth>
                          ...
                          >
                            {allUserTypes.map((column) => (
                              <MenuItem key={column.value} value={column.label}>
